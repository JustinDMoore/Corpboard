...
//    if ([Store.sharedInstance.arrayOfItemsInCart count]) return 1;
//    else return 0;
//}
//
...
////        return x;
////    }
//    if ([Store.sharedInstance.arrayOfItemsInCart count]) return [Store.sharedInstance.arrayOfItemsInCart count] + 1;
//    else return 0;
//}
//
...
//    
//    if ((int)indexPath.row > [Store.sharedInstance.arrayOfItemsInCart count] - 1) {
...
//    PFObject *item = Store.sharedInstance.arrayOfItemsInCart[indexPath.row];
...
//    
//     if ((int)indexPath.row > [Store.sharedInstance.arrayOfItemsInCart count] - 1) return;
//    
...
//    PFObject *item = Store.sharedInstance.arrayOfItemsInCart[indexPathOfEdit.row];
...
//-(void)calculateTotal {
//    [self.arrayOfPrices removeAllObjects];
//    for (PFObject *item in Store.sharedInstance.arrayOfItemsInCart) {
...
//
//-(void)checkForTotal {
//    if ([self.arrayOfPrices count] == [Store.sharedInstance.arrayOfItemsInCart count]) {
//        double total = 0.00;
//        double tax = 0.00;
...
//        [self.viewEdit closeView];
//        PFObject *itemToDelete = Store.sharedInstance.arrayOfItemsInCart[(int)indexPathOfEdit.row];
...
//            [Store.sharedInstance.arrayOfItemsInCart removeAllObjects];
