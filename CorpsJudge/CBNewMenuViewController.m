...
//
////NSTimer *timerBanners, *timerCheckForNews;
...
////    [self initUI];
////    [self setupShows];
////    [server getUnreadMessagesForUser];
////    [self sortScores];
...
////-(void)setupShows {
////    
////    if ([server.arrayOfAllShows count]) {
////        
...
////         forControlEvents:UIControlEventTouchUpInside];
////    
////    [self loadPageWithId:(int)[server.arrayOfBannerImages count] - 1 onPage:0];
...
////    
////    PFObject *bannerObj = server.arrayOfBannerObjects[sender.tag];
////    
...
////    
////    if ([server.arrayOfBannerImages count]) {
////        // load data for page
////        switch (page) {
////            case 0:
...
////        }
////        
////        [btnForBanner setBackgroundImage:[server.arrayOfBannerImages objectAtIndex:index] forState:UIControlStateNormal];
...
////    self.currIndex = (self.currIndex >= [server.arrayOfBannerImages count]-1) ? 0 : self.currIndex + 1;
////    [self loadPageWithId:self.currIndex onPage:1];
////    // Load content on the last page. This is either from the next item in the array
////    // or the first if we have reached the end.
////    self.nextIndex = (self.currIndex >= [server.arrayOfBannerImages count]-1) ? 0 : self.currIndex + 1;
...
////    
////    if ([server.arrayOfWorldClass count]) {
////        [server.arrayOfWorldClass sortedArrayUsingDescriptors:sortOfficialScoresDescriptor];
////    }
////    
...
////    if ([server.arrayOfAllShows count]) {
////        [server.arrayOfAllShows sortedArrayUsingDescriptors:sortShows];
////    }
////    PFObject *lastShow = [server.arrayOfAllShows lastObject];
////    NSDate *lastShowDate = lastShow[@"showDate"];
////    
////    //if today is after finals, just get the last four shows
////    if ([lastShowDate isInPast]) {
////        NSUInteger i = [server.arrayOfAllShows indexOfObject:[server.arrayOfAllShows lastObject]];
////        int x = 0;
////        while (x < 4) {
////            [self.arrayOfShowsYesterday addObject:server.arrayOfAllShows[i-x]];
////            x++;
////        }
////        
...
////        for (PFObject *show in server.arrayOfAllShows) {
////            
...
////            
////            corps = [server.arrayOfWorldClass objectAtIndex:indexPath.row + increment];
////            
////            if (corps) {
...
////            self.currIndex = (self.currIndex == 0) ? (int)[server.arrayOfBannerImages count]-1 : self.currIndex - 1;
////            [self loadPageWithId:self.currIndex onPage:1];
////            // Load content on the first page. This is either from the prev item in the array
////            // or the last if we have reached the beginning.
////            self.prevIndex = (self.currIndex == 0) ? (int)[server.arrayOfBannerImages count]-1 : self.currIndex - 1;
...
////    } else {
////        NSLog(@"Anonymous user needs profile.");
////    }
////}
////
////-(void)admin {
...
////    
////    UIImageView *imgFrom = [[UIImageView alloc] initWithFrame:CGRectMake(cell.frame.size.width - 30, cell.frame.size.height - 25, 30, 30)];
...
//-(void)setMsgBadge {
//    
//    if (server.numberOfMessages > 0) {
//        self.badgeMessages.badgeText = [NSString stringWithFormat:@"%i", server.numberOfMessages];
//    } else {
...
//    
//    int num = 0;
//    num += [server.objAdmin[@"feedback"] intValue];
//    num += [server.objAdmin[@"photos"] intValue];
//    num += [server.objAdmin[@"usersReported"] intValue];
//    num += [server.objAdmin[@"problems"] intValue];
//    
//    if (num > 0) {
...
//    if([CLLocationManager locationServicesEnabled]){
//        
//        [server updateUserLocation];
//        [server updateUserLastLogin];
//        
//        switch ([CLLocationManager authorizationStatus]) {
...
//-(void)denyLocation {
//    
//    [server setInstallationLocationAllowed:NO];
//}
//
//-(void)scrollToBottom {
//    
...
//    
//    
//    NSString *releasedVersion = server.objAdmin[@"releasedVersion"];
//    
//    NSDictionary *info = [[NSBundle mainBundle] infoDictionary];
...
//-(void)updateNow {
//    
//    [[UIApplication sharedApplication] openURL:[NSURL URLWithString:server.objAdmin[@"iOS7AppStoreLink"]]];
//}
//
//- (IBAction)support_tapped:(id)sender {
...
//- (IBAction)shop_tapped:(id)sender {
//    
//    BOOL storeOpen = [server.objAdmin[@"storeOpen"] boolValue];
//    if (storeOpen) {
