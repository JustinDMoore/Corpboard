...
-(id)initWithCoder:(NSCoder *)aDecoder {
    ...
    if (self) {
        ...
        self.arrayOfCategories = [[NSArray alloc] initWithObjects: @"Fan", @"Alumni", @"Active Member", @"Staff", @"Former Staff", @"Family of Member", @"Brass Player", @"Percussionist", @"Colorguard", nil];
